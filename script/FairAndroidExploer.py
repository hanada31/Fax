...
class FairAndroidExploer:
	def __init__(self, appName, laResultDir, exResultDir,tgResultDir, act_type, timeLimit):
	...
	def initial(self):
		...
		self.methodNumDict = self.getMethodNum( self.tgResultDir+ "instrument" +os.sep +self.appName + os.sep+ "instruMethods.txt")
